...
**모양** 오른쪽으로 미는 이중 갈매기(») — 뒤로 한 칸. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/displace.png -define webp:lossless=true art/tokens/displace.webp
```
