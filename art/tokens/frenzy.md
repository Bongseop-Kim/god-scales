...
**모양** 평행한 손톱자국 셋 — 대각선 세 줄. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/frenzy.png -define webp:lossless=true art/tokens/frenzy.webp
```
