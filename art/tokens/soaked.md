...
**모양** 물방울 하나. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/soaked.png -define webp:lossless=true art/tokens/soaked.webp
```
