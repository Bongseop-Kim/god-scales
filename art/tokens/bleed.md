...
**모양** 베인 자국(사선)과 그 아래 핏방울. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/bleed.png -define webp:lossless=true art/tokens/bleed.webp
```
