...
**모양** 총안(crenellation)이 있는 성벽과 성문. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/bulwark.png -define webp:lossless=true art/tokens/bulwark.webp
```
