...
**모양** 바닥을 치고 되튀는 화살 — V자 궤적 + 촉. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/deflect.png -define webp:lossless=true art/tokens/deflect.webp
```
