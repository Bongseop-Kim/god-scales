...
**모양** 받침 위에 선 굵은 위쪽 화살표. 12×12 픽셀 격자 × 16 — 얇은 선 금지(R-33), 형태가 뜻을 든다.
...
```
magick art/_src/tokens/might.png -define webp:lossless=true art/tokens/might.webp
```
