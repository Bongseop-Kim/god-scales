...
패시브 `guard` 보호. **아트는 P-30 §2가 정한 것을 그대로 받는다.** 신 색은 **아이기스 테두리**에만 2~3픽셀.
...
```
magick art/_src/sprites/enemy_god_athena.png -alpha on -fuzz 35% -transparent '#00ff00' \
  -trim +repage art/sprites/enemy_god_athena.png
```
