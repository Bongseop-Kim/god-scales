...
**파일** PNG 알파. `surface_olive_leaf_idle_1.png`~`surface_olive_leaf_idle_4.png`는 각각 `896×1024`, `surface_olive_leaf.png`는 4프레임 가로 스트립 `3584×1024`다.
...
**기존 원본 변환 기록(참고 전용)** — 현재 원본은 `art/_src/props/surface_olive_leaf-base.png`, 재현 가능한 run은 `art/_src/sprite-runs/surface_olive_leaf/`에 있다.
