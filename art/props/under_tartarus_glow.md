...
**파일** PNG 알파. `under_tartarus_glow_idle_1.png`~`under_tartarus_glow_idle_4.png`는 각각 `896×1024`, `under_tartarus_glow.png`는 4프레임 가로 스트립 `3584×1024`다.
...
**기존 원본 변환 기록(참고 전용)** — 현재 원본은 `art/_src/props/under_tartarus_glow-base.png`, 재현 가능한 run은 `art/_src/sprite-runs/under_tartarus_glow/`에 있다.
