...
```
magick art/_src/cards/ares_defend.png -gravity center -crop 1365x1024+0+0 +repage \
  -filter Lanczos -resize 512x384! -quality 88 art/cards/ares_defend.webp
```
