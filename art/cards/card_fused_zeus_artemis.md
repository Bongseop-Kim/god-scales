# `card_fused_zeus_artemis.webp` — 사냥의 천둥 (제우스 + 아르테미스)
...
```text
A single fused emblem filling the frame: a single arrow in flight whose shaft is a bolt of gold, drawn as one hard diagonal streak with a pale amethyst fletching. Treat it like a game ability emblem: one instantly readable shape built from a few decisive angular strokes with hard corners, thick and heavy, no thin lines, no scenery, no architecture, no clouds.
