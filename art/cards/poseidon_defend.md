# `poseidon_defend.webp` — 포세이돈 · 방어 태그
...
```
magick art/_src/cards/poseidon_defend.png -gravity center -crop 1365x1024+0+0 +repage \
  -filter Lanczos -resize 512x384! -quality 88 art/cards/poseidon_defend.webp
```
