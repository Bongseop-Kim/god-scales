# `card_poseidon_18.webp` — 해안 파쇄 (포세이돈)
...
```
magick art/_src/cards/card_poseidon_18.png -gravity center -crop 1365x1024+0+0 +repage \
  -filter Lanczos -resize 320x240! -quality 80 art/cards/card_poseidon_18.webp
```
