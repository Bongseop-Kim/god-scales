...
```
magick art/_src/cards/athena_attack.png -gravity center -crop 1365x1024+0+0 +repage \
  -quality 88 art/cards/athena_attack.webp
```
...
```text
A single bold spear symbol filling the frame, tearing DIAGONALLY from the top-left corner down to the bottom-right, striking a slab of pale cracked marble in the lower third and splitting it with a few short cracks. Treat it like a game ability emblem: one instantly readable shape, thick and heavy, built from a few decisive angular strokes with hard corners. No thin lines, no branching filaments, no scenery, no architecture, no clouds. It spans the frame corner to corner and dominates it.
