# `card_fused_zeus_ares.webp` — 피의 낙뢰 (제우스 + 아레스)
...
```
magick art/_src/cards/card_fused_zeus_ares.png -gravity center -crop 1365x1024+0+0 +repage \
  -filter Lanczos -resize 320x240! -quality 80 art/cards/card_fused_zeus_ares.webp
```
