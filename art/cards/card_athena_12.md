# `card_athena_12.webp` — 전열 밀어내기 (아테나)
...
```
magick art/_src/cards/card_athena_12.png -gravity center -crop 1365x1024+0+0 +repage \
  -filter Lanczos -resize 320x240! -quality 80 art/cards/card_athena_12.webp
```
