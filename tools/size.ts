...
const bundled: { directory: string; extension: string; only?: string[] }[] = [
  ...
  { directory: "art/kenney", extension: ".png", only: ["panel-border-007-bronze.png", "panel-border-010-bronze.png", "token-frame-bronze.png", "crosshair-030-32.png", "crosshair-167.png"] },
